...
func New(ctx context.Context, expr logicalplan.Node, storage storage.Scanners, opts *execopts.Options) (model.VectorOperator, error) {
...
func newOperator(ctx context.Context, expr logicalplan.Node, storage storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
	switch e := expr.(type) {
...
func newVectorSelector(ctx context.Context, e *logicalplan.VectorSelector, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newCall(ctx context.Context, e *logicalplan.FunctionCall, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newAbsentOverTimeOperator(ctx context.Context, call *logicalplan.FunctionCall, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newRangeVectorFunction(ctx context.Context, e *logicalplan.FunctionCall, t *logicalplan.MatrixSelector, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
	// TODO(saswatamcode): Range vector result might need new operator
	// before it can be non-nested. https://github.com/thanos-io/promql-engine/issues/39
...
func newSubqueryFunction(ctx context.Context, e *logicalplan.FunctionCall, t *logicalplan.Subquery, storage storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
	// TODO: We dont implement ext functions
	if parse.IsExtFunction(e.Func.Name) {
		return nil, parse.ErrNotImplemented
	}

	nOpts := execopts.NestedOptionsForSubquery(opts, t.Step, t.Range, t.Offset)
...
func newInstantVectorFunction(ctx context.Context, e *logicalplan.FunctionCall, storage storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newAggregateExpression(ctx context.Context, e *logicalplan.Aggregation, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newBinaryExpression(ctx context.Context, e *logicalplan.Binary, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newVectorBinaryOperator(ctx context.Context, e *logicalplan.Binary, storage storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newScalarBinaryOperator(ctx context.Context, e *logicalplan.Binary, storage storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newUnaryExpression(ctx context.Context, e *logicalplan.Unary, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
	next, err := newOperator(ctx, e.Expr, scanners, opts, hints)
	if err != nil {
		return nil, err
	}
...
func newStepInvariantExpression(ctx context.Context, e *logicalplan.StepInvariantExpr, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newDeduplication(ctx context.Context, e logicalplan.Deduplicate, scanners storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newRemoteExecution(ctx context.Context, e logicalplan.RemoteExecution, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func newDuplicateLabelCheck(ctx context.Context, e *logicalplan.CheckDuplicateLabels, storage storage.Scanners, opts *execopts.Options, hints promstorage.SelectHints) (model.VectorOperator, error) {
...
func getTimeRangesForVectorSelector(n *logicalplan.VectorSelector, opts *execopts.Options, evalRange int64) (int64, int64) {
	start := opts.Start.UnixMilli()
	end := opts.End.UnixMilli()
	if n.Timestamp != nil {
		start = *n.Timestamp
