...
// AppendSampleWithHint appends a sample and lazily pre-allocates capacity if needed.
// Use this when you know the expected number of samples to avoid repeated slice growth.
func (s *StepVector) AppendSampleWithHint(id uint64, val float64, hint int) {
...
// AppendHistogramWithHint appends a histogram and lazily pre-allocates capacity if needed.
// Use this when you know the expected number of histograms to avoid repeated slice growth.
func (s *StepVector) AppendHistogramWithHint(histogramID uint64, h *histogram.FloatHistogram, hint int) {
