...
func NewVectorSelector(pool *model.VectorPool, selector *seriesSelector, mint, maxt time.Time, step time.Duration, stepsBatch, shard, numShards int) model.VectorOperator {
