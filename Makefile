...
bench-old: benchmarks
	...
	@go test ./... -bench 'BenchmarkRangeQuery/.*/old_engine'  -run none -count 1 | sed -u 's/\/old_engine//' > benchmarks/old.out
	@go test ./... -bench 'BenchmarkNativeHistograms/.*/old_engine'  -run none -count 1 | sed -u 's/\/old_engine//' >> benchmarks/old.out

.PHONY: bench-new
bench-new: benchmarks
	@echo "Benchmarking new engine"
	@go test ./... -bench 'BenchmarkRangeQuery/.*/new_engine'  -run none -count 1 | sed -u 's/\/new_engine//' > benchmarks/new.out
	@go test ./... -bench 'BenchmarkNativeHistograms/.*/new_engine'  -run none -count 1 | sed -u 's/\/new_engine//' >> benchmarks/new.out
